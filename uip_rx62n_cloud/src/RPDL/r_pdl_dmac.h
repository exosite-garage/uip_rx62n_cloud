...
#define PDL_DMAC_TRIGGER_IRQ0		VECT__IRQ0
#define PDL_DMAC_TRIGGER_IRQ1		VECT__IRQ1
#define PDL_DMAC_TRIGGER_IRQ2		VECT__IRQ2
#define PDL_DMAC_TRIGGER_IRQ3		VECT__IRQ3
...
#define PDL_DMAC_CLEAR_DTIF					0x0010u
#define PDL_DMAC_CLEAR_ESIF					0x0020u

/* Modify registers selection */
#define PDL_DMAC_UPDATE_SOURCE				0x0040u
#define PDL_DMAC_UPDATE_DESTINATION			0x0080u
#define PDL_DMAC_UPDATE_COUNT				0x0100u
#define PDL_DMAC_UPDATE_SIZE				0x0200u
#define PDL_DMAC_UPDATE_OFFSET				0x0400u
#define PDL_DMAC_UPDATE_REPEAT_SOURCE		0x0800u
#define PDL_DMAC_UPDATE_REPEAT_DESTINATION	0x1000u
