...
*				: 2010.07.15
*				: Ver 0.11
*				: Added new globals for Multi-processor mode; 
*				: Added R_SCI_SetAll, R_SCI_CreateAll, R_SCI_SendStationID, R_SCI_SendData, R_SCI_ReceiveStationID, R_SCI_ReceiveData;
*				: Modified R_SCI_SendAll, R_SCI_ReceiveAll; Modified function macros for RX62N SCI.
*""FILE COMMENT END""**************************************************/
