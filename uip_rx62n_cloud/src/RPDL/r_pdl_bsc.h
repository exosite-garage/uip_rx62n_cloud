...
*				: 2010.09.14
*				: Ver 0.11
*				: Removed the options of SDCLK output control.
*""FILE COMMENT END""**************************************************/
...
/* WAIT pin selection */            	
#define PDL_BSC_WAIT_A					0x02000000ul
#define PDL_BSC_WAIT_B					0x04000000ul
#define PDL_BSC_WAIT_C					0x08000000ul
#define PDL_BSC_WAIT_D					0x10000000ul
...
/* Bus width */
#define PDL_BSC_WIDTH_16					0x0001ul
#define PDL_BSC_WIDTH_8						0x0002ul
#define PDL_BSC_WIDTH_32					0x0004ul
                                        	
/* Endian mode */                       	
#define PDL_BSC_ENDIAN_SAME					0x0008ul
#define PDL_BSC_ENDIAN_OPPOSITE				0x0010ul
                                        	
/* Write access mode */                 	
#define PDL_BSC_WRITE_BYTE					0x0020ul
#define PDL_BSC_WRITE_SINGLE				0x0040ul
                                        	
/* External wait control */             	
#define PDL_BSC_WAIT_DISABLE				0x0080ul
#define PDL_BSC_WAIT_ENABLE					0x0100ul
                                        	
/* Page access control */               	
#define PDL_BSC_PAGE_READ_DISABLE			0x0200ul
#define PDL_BSC_PAGE_READ_NORMAL			0x0400ul
#define PDL_BSC_PAGE_READ_CONTINUOUS		0x0800ul
#define PDL_BSC_PAGE_WRITE_DISABLE			0x1000ul
#define PDL_BSC_PAGE_WRITE_ENABLE			0x2000ul
...
/* Configuration selection */
/* Bus width */
#define PDL_BSC_SDRAM_WIDTH_16				0x0001ul
#define PDL_BSC_SDRAM_WIDTH_8				0x0002ul
#define PDL_BSC_SDRAM_WIDTH_32				0x0004ul

/* Endian mode */
#define PDL_BSC_SDRAM_ENDIAN_SAME			0x0008ul
#define PDL_BSC_SDRAM_ENDIAN_OPPOSITE		0x0010ul

/* Continuous access mode */
#define PDL_BSC_SDRAM_CONT_ACCESS_ENABLE	0x0020ul
#define PDL_BSC_SDRAM_CONT_ACCESS_DISABLE	0x0040ul

/* Address multiplex selection */
#define PDL_BSC_SDRAM_8_BIT_SHIFT			0x0080ul
#define PDL_BSC_SDRAM_9_BIT_SHIFT			0x0100ul
#define PDL_BSC_SDRAM_10_BIT_SHIFT			0x0200ul
#define PDL_BSC_SDRAM_11_BIT_SHIFT			0x0400ul
