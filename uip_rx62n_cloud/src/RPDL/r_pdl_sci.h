...
*				: 2010.07.15
*				: Ver 0.11
*				: Added new API, R_SCI_Set, & its options; Added GSM clock control;
*				: Added options for Multi-processor mode; 
*				: 2010.09.02
*				: Ver 0.53
*				: Moved the LSB/MSB and inversion control into the
*				: Smart card section.
*""FILE COMMENT END""**************************************************/
...
/* ------------------------ */
/* Pin selection */
#define PDL_SCI_PIN_SCI1_A	0x01ul
#define PDL_SCI_PIN_SCI1_B	0x02ul
#define PDL_SCI_PIN_SCI2_A	0x04ul
#define PDL_SCI_PIN_SCI2_B	0x08ul
#define PDL_SCI_PIN_SCI3_A	0x10ul
#define PDL_SCI_PIN_SCI3_B	0x20ul
#define PDL_SCI_PIN_SCI6_A	0x40ul
#define PDL_SCI_PIN_SCI6_B	0x80ul
...
/* Parity selection */
#define PDL_SCI_PARITY_EVEN		0x00000200ul
#define PDL_SCI_PARITY_ODD		0x00000400ul

/* Asynchronous-only selections */

/* Data clock source */
#define PDL_SCI_CLK_INT_IO		0x00000800ul
#define PDL_SCI_CLK_EXT_DIV_8	0x00001000ul
#define PDL_SCI_CLK_EXT_DIV_16	0x00002000ul
#define PDL_SCI_CLK_TMR			0x00004000ul

/* Data length */
#define PDL_SCI_8_BIT_LENGTH	0x00008000ul
#define PDL_SCI_7_BIT_LENGTH	0x00010000ul

/* Parity selection */
#define PDL_SCI_PARITY_NONE		0x00020000ul

/* Stop bit length */
#define PDL_SCI_STOP_1			0x00040000ul
#define PDL_SCI_STOP_2			0x00080000ul
...
/* Data clock source */
#define PDL_SCI_CLK_EXT			0x00000800ul

/* Smart card-only selections */

/* Data transfer format */
#define PDL_SCI_LSB_FIRST		0x00000800ul
#define PDL_SCI_MSB_FIRST		0x00001000ul

/* Data inversion */
#define PDL_SCI_INVERSION_OFF	0x00002000ul
#define PDL_SCI_INVERSION_ON	0x00004000ul

/* Base clock pulse cycle count */
#define PDL_SCI_BCP_32			0x00008000ul
#define PDL_SCI_BCP_64			0x00010000ul
#define PDL_SCI_BCP_93			0x00020000ul
#define PDL_SCI_BCP_128			0x00040000ul
#define PDL_SCI_BCP_186			0x00080000ul
#define PDL_SCI_BCP_256			0x00100000ul
#define PDL_SCI_BCP_372			0x00200000ul
#define PDL_SCI_BCP_512			0x00400000ul

/* Block transfer mode */
#define PDL_SCI_BLOCK_MODE_OFF	0x00800000ul
#define PDL_SCI_BLOCK_MODE_ON	0x01000000ul

/* GSM mode */
#define PDL_SCI_GSM_MODE_OFF	0x02000000ul
#define PDL_SCI_GSM_MODE_ON		0x04000000ul

/* Clock output control */
#define PDL_SCI_SCK_OUTPUT_OFF	0x08000000ul
#define PDL_SCI_SCK_OUTPUT_LOW	0x10000000ul
#define PDL_SCI_SCK_OUTPUT_ON	0x20000000ul
#define PDL_SCI_SCK_OUTPUT_HIGH	0x40000000ul
