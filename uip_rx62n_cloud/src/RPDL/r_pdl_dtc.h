...
* 				: 2010.06.16
*				: Ver 0.11
*				: Added register parameters to R_DTC_Control.
* 				: 2010.07.22
*				: Ver 0.12
*				: Added Chain as a trigger option.
* 				: 2010.08.10
*				: Ver 0.13
*				: Modified R_DTC_Control to pass the trigger vector.
*""FILE COMMENT END""**************************************************/
...
#define PDL_DTC_TRIGGER_IRQ0		(uint32_t)(VECT__IRQ0 << 24)
#define PDL_DTC_TRIGGER_IRQ1		(uint32_t)(VECT__IRQ1 << 24)
#define PDL_DTC_TRIGGER_IRQ2		(uint32_t)(VECT__IRQ2 << 24)
#define PDL_DTC_TRIGGER_IRQ3		(uint32_t)(VECT__IRQ3 << 24)
#define PDL_DTC_TRIGGER_IRQ4		(uint32_t)(VECT__IRQ4 << 24)
#define PDL_DTC_TRIGGER_IRQ5		(uint32_t)(VECT__IRQ5 << 24)
#define PDL_DTC_TRIGGER_IRQ6		(uint32_t)(VECT__IRQ6 << 24)
#define PDL_DTC_TRIGGER_IRQ7		(uint32_t)(VECT__IRQ7 << 24)
#define PDL_DTC_TRIGGER_IRQ8		(uint32_t)(VECT__IRQ8 << 24)
#define PDL_DTC_TRIGGER_IRQ9		(uint32_t)(VECT__IRQ9 << 24)
#define PDL_DTC_TRIGGER_IRQ10		(uint32_t)(VECT__IRQ10 << 24)
#define PDL_DTC_TRIGGER_IRQ11		(uint32_t)(VECT__IRQ11 << 24)
#define PDL_DTC_TRIGGER_IRQ12		(uint32_t)(VECT__IRQ12 << 24)
#define PDL_DTC_TRIGGER_IRQ13		(uint32_t)(VECT__IRQ13 << 24)
#define PDL_DTC_TRIGGER_IRQ14		(uint32_t)(VECT__IRQ14 << 24)
#define PDL_DTC_TRIGGER_IRQ15		(uint32_t)(VECT__IRQ15 << 24)
...
#define PDL_DTC_TRIGGER_DMACI0		(uint32_t)(VECT_DMACA_DMAC0I << 24)
#define PDL_DTC_TRIGGER_DMACI1		(uint32_t)(VECT_DMACA_DMAC1I << 24)
#define PDL_DTC_TRIGGER_DMACI2		(uint32_t)(VECT_DMACA_DMAC2I << 24)
#define PDL_DTC_TRIGGER_DMACI3		(uint32_t)(VECT_DMACA_DMAC3I << 24)
