...
#define PDL_SPI_CLOCK_DELAY_2	0x00000001ul
#define PDL_SPI_CLOCK_DELAY_3	0x00000002ul
#define PDL_SPI_CLOCK_DELAY_4	0x00000004ul
#define PDL_SPI_CLOCK_DELAY_5	0x00000008ul
#define PDL_SPI_CLOCK_DELAY_6	0x00000010ul
#define PDL_SPI_CLOCK_DELAY_7	0x00000020ul
#define PDL_SPI_CLOCK_DELAY_8	0x00000040ul

/* Extended SSL negation delay */
#define PDL_SPI_SSL_DELAY_2		0x00000080ul
#define PDL_SPI_SSL_DELAY_3		0x00000100ul
#define PDL_SPI_SSL_DELAY_4		0x00000200ul
#define PDL_SPI_SSL_DELAY_5		0x00000400ul
#define PDL_SPI_SSL_DELAY_6		0x00000800ul
#define PDL_SPI_SSL_DELAY_7		0x00001000ul
#define PDL_SPI_SSL_DELAY_8		0x00002000ul

/* Extended next-access delay */
#define PDL_SPI_NEXT_DELAY_2	0x00004000ul
#define PDL_SPI_NEXT_DELAY_3	0x00008000ul
#define PDL_SPI_NEXT_DELAY_4	0x00010000ul
#define PDL_SPI_NEXT_DELAY_5	0x00020000ul
#define PDL_SPI_NEXT_DELAY_6	0x00040000ul
#define PDL_SPI_NEXT_DELAY_7	0x00080000ul
#define PDL_SPI_NEXT_DELAY_8	0x00100000ul
...
#define PDL_SPI_CLOCK_DELAY_1			0x01u
#define PDL_SPI_CLOCK_DELAY_EXTENDED	0x02u

/* Extended timing selection */
#define PDL_SPI_SSL_DELAY_1				0x04u
#define PDL_SPI_SSL_DELAY_EXTENDED		0x08u

/* Next-access delay */
#define PDL_SPI_NEXT_DELAY_1			0x10u
